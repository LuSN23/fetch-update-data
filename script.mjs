//Para GET - Recuperar usuários/dados - uma chave grátis somente leitura basta
import 'dotenv/config';
import fetch from 'node-fetch';

fetch('https://reqres.in/api/users?page=2', {
  method: 'GET',                            //método para puxar do servidor os usuários
  headers: {
    'Content-Type': 'application/json',
    'x-api-key': process.env.API_KEY_TEST   //uso de uma public key
  }
})
...
//Para POST - Adicionar usuários/dados - necessita de uma chave de API paga
// import 'dotenv/config';
// import fetch from 'node-fetch';
